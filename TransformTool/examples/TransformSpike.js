...
App.prototype.addPictures = function(){
	...
	var i = 0;
	var n = this.loader.images.length-2;
	for (i=0; i<n; i++){
		this.displayList.push(new Picture(this.loader.images[i], i*offx, i*offy));
	}
  var t1 = new Text(0, 0, 300, 40,'PLEASE JOIN US TO',30);
  var t2 = new Text(0, 100, 200, 200,'TOAST THE NEW YEAR IN STYLE',30);
  var t3 = new Text(0, 300, 200, 200,'DECEMBER 31, 2013 8PM \'TIL LONG PAST MIDNIGHT',30);
  var t4 = new Text(0, 400, 300, 40,'RSVP (SPARKLY ATTIRE)',30);

  this.displayList.push(t1,t2,t3,t4);
};
